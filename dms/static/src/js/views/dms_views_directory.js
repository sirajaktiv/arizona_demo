...
*
**********************************************************************************/
odoo.define('dms_views.directory', function(require) {
"use strict";
...
FormController.include({
    ...
    _updateButtons: function () {
    	this._super.apply(this, arguments);
    	if(this.$buttons && this.modelName === 'dms.directory') {
    ...
    _updateSidebar: function () {
    	this._super.apply(this, arguments);
    	if(this.sidebar && this.modelName === 'dms.directory') {
    		var actions = this.updateActions;
...
ListRenderer.include({
	_setDecorationClasses: function (record, $tr) {
		this._super.apply(this, arguments);
		if(record.model === 'dms.directory' && !record.data.perm_unlink) {
