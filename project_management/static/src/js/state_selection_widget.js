odoo.define('web.state_selection', function (require) {
    "use strict";

    var AbstractField = require('web.basic_fields');

    var StateSelection = AbstractField.StateSelectionWidget.include({
        _prepareDropdownValues: function () {
            ...
            var stage_data = {
                ...
                legend_inprogress: this.recordData.legend_inprogress || undefined,
            };
            _.map(this.field.selection || [], function (selection_item) {
                ...
                if (selection_item[0] === 'normal') {
                    ...
                    value.state_name = stage_data.legend_inprogress ? stage_data.legend_inprogress : selection_item[1];
                } else {
